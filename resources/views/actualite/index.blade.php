                        ...
                        <div class="card-body">
                            <div class="table-opration d-flex justify-content-end flex-column flex-sm-row">
                                <div class="btn-group me-sm-2 mb-2 zindex-popover">
                                    <a href="{{ route('actualite.create') }}" class="btn btn-success text-light "  aria-expanded="false">
                                    ...
                                    <tbody>
                                        @foreach ($actualite as $item)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    @can('update', $item)
                                                        <a href="{{ route('actualite.edit',$item->id) }} " class="btn btn-warning text-light mx-3"><i class="me-2 fa fa-edit"></i>Modifier</a>
                                                    @endcan
                                                    @can('delete', $item)
                                ...
                                <div class="card  bg-secondary text-light">
                                    <div class="card-body d-flex align-items-center justify-content-center flex-column">
                                        <div class="preview-pane text-center">
                                            ...
                                            <span class="project-name display-5 fw-bold  d-flex justify-content-center">Actualites</span>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="tertiary-list pt-3">
                                                <ul class="pt-3 ps-0 list-unstyled">
                                                    <li><a href="button" class="btn btn-outline-primary w-100 mb-3"><i class="bi bi-file-earmark-arrow-down-fill fs-5 me-2"></i>Exporter en fichier pdf</a></li>
                                                    <li><a href="/exportActualite" class="btn btn-outline-primary w-100 mb-3"><i class="bi bi-file-earmark-arrow-up-fill fs-5 me-2"></i>Exporter en fichier excel</a></li>
                                                </ul>
                                            </div>
                                    </div>
                                </div>
