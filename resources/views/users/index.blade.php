                        ...
                        <div class="card-body">
                            <div class="table-opration d-flex justify-content-end flex-column flex-sm-row">
                                <div class="btn-group me-sm-2 mb-2 zindex-popover">
                                    <a href="{{ route('user.create') }}" class="btn btn-success text-light "  aria-expanded="false">
                                        ...
                                        @foreach ($user as $item)
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <p class="mb-0 ms-1 d-inline-block">{{ $item->name }}</p>
                                                </td>   
                                                <td class="text-truncate">
                                                    <p class="mb-0 ms-1 d-inline-block">{{ $item->email }}</p>
                                                </td>
                                                <td class="text-truncate">
                                                    <p class="mb-0 ms-1 d-inline-block">{{ $item->role }}</p>
                                                </td>                               
                                                <td>
                                                    <p class="mb-0 ms-1 d-inline-block">{{ $item->dateformatted() }}</p>
                                                </td>
                                                <td class="d-flex">
                                                    <a href="{{ route('user.edit',$item->id) }} " class="btn btn-warning text-light mx-3"><i class="me-2 fa fa-edit"></i> Modifier</a>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" class="btn btn-secondary" onclick="document.getElementById('model-open-{{$item->id}}').style.display='none'" data-bs-dismiss="modal">Annuler</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="card  bg-secondary text-light">
                                    <div class="card-body d-flex align-items-center justify-content-center flex-column">
                                        <div class="preview-pane text-center">
                                            ...
                                            <span class="project-name display-5 fw-bold  d-flex justify-content-center">Utilisateurs</span>
                                ...
                                <div class="card  color-bg-200">
                                    ...
                                    <div class="card-body">
                                            <div class="team-filter pb-3">
                                                <div class="dropdown">
                                                    <button class="btn btn-dark w-100" type="button" aria-expanded="false">
                                                        @if (Auth::user())
                                                            {{ Auth::user()->role }}
                                                        @endif
                                                    </button>
                                            ...
                                            <div class="tertiary-list pt-3">
                                                <ul class="pt-3 ps-0 list-unstyled">
                                                    <li><a href="#" class="btn btn-outline-primary w-100 mb-3"><i class="bi bi-file-earmark-arrow-down-fill fs-5 me-2"></i>Exporter en fichier pdf</a></li>
                                                    <li><a href="/exportUser" class="btn btn-outline-primary w-100 mb-3"><i class="bi bi-file-earmark-arrow-up-fill fs-5 me-2"></i>Exporter en fichier excel</a></li>
                                                </ul>
                                            </div>
                                    </div>
                                </div>
